...
export const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    writeUp: {
      ...
      overview:
        "Battery Vitals is an innovative microcontroller-based hardware testing apparatus and IoT telemetry platform developed as our first-year engineering project at the Faculty of Information Technology, University of Moratuwa. Following project evaluations at the end of the academic year, our project was selected by faculty evaluators from among all first-year microcontroller hardware projects to be featured as an official live exhibit at FITExpo 2025. Over the 2-day exhibition, the team showcased and demonstrated the working testbed to visiting university faculty, industry professionals, students, and hundreds of public visitors. Engineered to evaluate battery health, optimize usage efficiency, and ensure operational safety, the system autonomously conducts cyclic charge, rest, and discharge protocols across Li-ion 18650, Li-Po, and 12V Lead-Acid batteries. By sampling voltage, current, and temperature at sub-second intervals, Battery Vitals computes battery State of Health (SOH), internal resistance, and empirical decay curves, broadcasting telemetry simultaneously to an onboard 16×4 LCD and an interactive web dashboard. Minothma served as an official booth presenter across both days and was awarded the Certificate of Appreciation signed by Dean Mr. B.H. Sudantha and Director Dr. T.M. Thanthriwatta.",
      contributions: [
        {
