...
export function ProjectCard({ project, onReadMore }: ProjectCardProps) {
  return (
    <div className="group relative rounded-xl bg-[#0c1017] border border-white/[0.08] hover:border-amber-accent/40 transition-all duration-200 p-6 sm:p-8 space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        {onReadMore && (
          <button
            ...
            className="px-3.5 py-1.5 rounded-full text-[11px] font-mono tracking-wider text-slate-300 border border-white/20 hover:border-amber-accent hover:text-amber-accent transition-colors"
          >
            READ MORE
          </button>
        )}
